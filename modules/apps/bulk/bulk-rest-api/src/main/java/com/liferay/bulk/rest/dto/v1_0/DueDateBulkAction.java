 ...
 */
@Generated("")
@GraphQLName("DueDateBulkAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DueDateBulkAction")
public class DueDateBulkAction extends BulkAction implements Serializable {

	public static DueDateBulkAction toDTO(String json) {
		return ObjectMapperUtil.readValue(DueDateBulkAction.class, json);
	}

	public static DueDateBulkAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DueDateBulkAction.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.DueDateBulkAction",
		name = "x-class-name"
	)
