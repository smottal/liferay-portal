...
public class CommerceOrderAttachmentTestUtil {
	...
	public static void initialize(Class<?> clazz) throws Exception {
		...
		BatchEngineTestUtil.processBatchEngineUnits(
			...
			new String[] {
				".com.liferay.commerce.internal.batch.00.list.type.definition",
				".com.liferay.commerce.internal.batch.01.object.definition",
				".com.liferay.commerce.internal.batch.02.list.type.definition",
