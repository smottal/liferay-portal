...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {skuByExternalReferenceCode(externalReferenceCode: ___){cost, depth, discontinued, discontinuedDate, displayDate, expirationDate, externalReferenceCode, gtin, height, id, inventoryLevel, manufacturerPartNumber, neverExpire, price, productId, productName, promoPrice, published, purchasable, replacementSkuExternalReferenceCode, replacementSkuId, sku, skuOptions, subscriptionConfiguration, unspsc, weight, width}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {skuByExternalReferenceCodeSubscriptionConfiguration(externalReferenceCode: ___){enable, length, numberOfLength, overrideSubscriptionInfo, subscriptionType, subscriptionTypeSettings}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public SkuSubscriptionConfiguration
			skuByExternalReferenceCodeSubscriptionConfiguration(
				@GraphQLName("externalReferenceCode") String
					externalReferenceCode)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {skuIdSubscriptionConfiguration(id: ___){enable, length, numberOfLength, overrideSubscriptionInfo, subscriptionType, subscriptionTypeSettings}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public SkuSubscriptionConfiguration skuIdSubscriptionConfiguration(
			@GraphQLName("id") Long id)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			...
			skuSubscriptionConfigurationResource ->
				skuSubscriptionConfigurationResource.
					getSkuIdSubscriptionConfiguration(id));
	}
	...
	public class
		GetSkuByExternalReferenceCodeSubscriptionConfigurationTypeExtension {

		public GetSkuByExternalReferenceCodeSubscriptionConfigurationTypeExtension(
			Catalog catalog) {
