...
public class OrderNoteResourceTest extends BaseOrderNoteResourceTestCase {
	...
	public void testPatchOrderNote() throws Exception {
		OrderNote postOrderNote = orderNoteResource.postOrderIdOrderNote(
			_commerceOrder.getCommerceOrderId(), randomOrderNote());

		OrderNote randomPatchOrderNote = randomPatchOrderNote();

		orderNoteResource.patchOrderNote(
			postOrderNote.getId(), randomPatchOrderNote);

		OrderNote expectedOrderNote = postOrderNote.clone();

		BeanTestUtil.copyProperties(randomPatchOrderNote, expectedOrderNote);

		OrderNote getOrderNote = orderNoteResource.getOrderNote(
			postOrderNote.getId());

		assertEquals(expectedOrderNote, getOrderNote);
	...
	public void testPatchOrderNoteByExternalReferenceCode() throws Exception {
		...
		orderNoteResource.patchOrderNoteByExternalReferenceCode(
			postOrderNote.getExternalReferenceCode(), randomPatchOrderNote);
