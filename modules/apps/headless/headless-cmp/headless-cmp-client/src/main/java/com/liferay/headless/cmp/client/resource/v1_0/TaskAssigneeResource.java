...
public interface TaskAssigneeResource {
	...
	public static class Builder {
		...
		public TaskAssigneeResource build() {
			return new TaskAssigneeResourceImpl(this);
		}
	...
	public static class TaskAssigneeResourceImpl
		...
		public Page<TaskAssignee> getTaskAssigneesPage(
			...
			try {
				return Page.of(content, TaskAssigneeSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private TaskAssigneeResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			TaskAssigneeResource.class.getName());
