...
page import="com.liferay.site.pim.site.initializer.internal.display.context.MapPIMChannelFieldDisplayContext" %><%@
page import="com.liferay.site.pim.site.initializer.internal.display.context.PIMConnectorFieldMappingDisplayContext" %><%@
