...
@Component(
	property = {
		"frontend.data.set.name=" + PIMFDSNames.CONNECTORS,
		"service.ranking:Integer=100"
	},
	service = FDSFilter.class
)
public class PIMConnectorKeySelectionFDSFilter extends BaseSelectionFDSFilter {
	...
	public List<SelectionFDSFilterItem> getSelectionFDSFilterItems(
		...
		return TransformUtil.transform(
			...
			pimConnector -> new SelectionFDSFilterItem(
				pimConnector.getName(locale), pimConnector.getKey()));
	}
