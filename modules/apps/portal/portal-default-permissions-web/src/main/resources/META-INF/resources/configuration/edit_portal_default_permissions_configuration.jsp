...
<%
PortalDefaultPermissionsConfiguration portalDefaultPermissionsConfiguration = (PortalDefaultPermissionsConfiguration)request.getAttribute(PortalDefaultPermissionsWebKeys.PORTAL_DEFAULT_PERMISSIONS_CONFIGURATION);
...
EditPortalDefaultPermissionsConfigurationDisplayContext editPortalDefaultPermissionsConfigurationDisplayContext = new EditPortalDefaultPermissionsConfigurationDisplayContext(request, portalDefaultPermissionsConfiguration, renderRequest, roleTypeContributorProvider);
