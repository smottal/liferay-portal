...
public class MarketplaceAppsGeneralPermissionsPanelApp extends BasePanelApp {
	...
	public String getPortletId() {
		return MarketplaceAppsPortletKeys.MARKETPLACE_APPS_GENERAL_PERMISSIONS;
	}
	...
	@Reference(
		target = "(javax.portlet.name=" + MarketplaceAppsPortletKeys.MARKETPLACE_APPS_GENERAL_PERMISSIONS+ ")"
	)
