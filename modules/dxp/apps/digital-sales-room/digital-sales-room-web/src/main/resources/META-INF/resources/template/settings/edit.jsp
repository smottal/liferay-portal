...
<%
EditDigitalSalesRoomTemplateSettingsDisplayContext editDigitalSalesRoomTemplateSettingsDisplayContext = (EditDigitalSalesRoomTemplateSettingsDisplayContext)request.getAttribute(EditDigitalSalesRoomTemplateSettingsDisplayContext.class.getName());
%>
	...
	<react:component
		...
		props='<%=
			HashMapBuilder.<String, Object>put(
				...
				"step", editDigitalSalesRoomTemplateSettingsDisplayContext.getStep()
			).build()
		%>'
	/>
</div>