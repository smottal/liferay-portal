...
<%
EditDigitalSalesRoomRoomSettingsDisplayContext editDigitalSalesRoomRoomSettingsDisplayContext = (EditDigitalSalesRoomRoomSettingsDisplayContext)request.getAttribute(EditDigitalSalesRoomRoomSettingsDisplayContext.class.getName());
%>
	...
	<react:component
		...
		props='<%=
			HashMapBuilder.<String, Object>put(
				...
				"step", editDigitalSalesRoomRoomSettingsDisplayContext.getStep()
			).build()
		%>'
	/>
</div>